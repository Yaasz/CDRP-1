    ...
    <div className="flex min-h-screen bg-purple-50/20">
      ...
      <div className="flex-1">
        <header className="sticky top-0 z-10 flex h-16 items-center gap-4 border-b bg-white px-6">
          <Link to="/charity/volunteers" className="flex items-center gap-2 text-sm font-medium text-gray-500">
            <ArrowLeft className="h-4 w-4" />
            <span>Back to Volunteers</span>
          </Link>
          <div className="flex-1">
            <h1 className="text-2xl font-semibold">Volunteer Profile</h1>
          </div>
