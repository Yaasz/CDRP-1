          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="text-lg md:text-xl text-gray-700 mb-8">
                Connecting communities, emergency services, and volunteers to coordinate effective disaster response and
                recovery efforts.
              </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">How CDRP Helps Communities</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
                Submit and access real-time disaster reports to stay informed about ongoing situations in your
                community.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
                Connect volunteers with organizations that need help during disaster response and recovery efforts.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
                Track and allocate resources efficiently to ensure they reach the areas and people that need them most.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">CDRP</h3>
              <p className="text-gray-400">
                Community Disaster Response Platform - Connecting communities for better disaster preparedness and
                response.
              </p>
            </div>
