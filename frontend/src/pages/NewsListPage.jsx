...
export default function NewsListPage() {
  ...
  const categories = [
    "All",
    ...new Set(newsArticles.map((news) => news.category).filter(Boolean)),
  ];
    ...
    return (
      <div className="text-center py-12 max-w-lg mx-auto bg-white p-8 rounded-lg shadow border border-gray-200">
        ...
        <p className="text-gray-600 mb-6">
          We're having trouble loading the news feed. Please try again later.
        </p>
        <button
          onClick={fetchNews}
    ...
    <div className="container mx-auto p-4 max-w-6xl">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Stay updated with the latest news related to disasters and response
          efforts
        </p>
      </div>
          ...
          {filteredNews.map((news) => (
            ...
            >
              ...
              <div className="relative h-48">
                <ImagePlaceholder src={news.image} alt={news.title} />
