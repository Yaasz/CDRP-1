      ...
      {accountType === "user" && (
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="signup-firstName" className="block text-sm font-semibold text-gray-700 mb-2">
                First Name
              </label>
            ...
            <div>
              <label htmlFor="signup-lastName" className="block text-sm font-semibold text-gray-700 mb-2">
                Last Name
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none">
