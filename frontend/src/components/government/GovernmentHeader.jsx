...
const GovernmentHeader = ({ title = "Dashboard", onMobileNavOpen }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            ...
            <h1 className="ml-2 md:ml-0 text-xl md:text-2xl font-semibold text-gray-900">{title}</h1>
          </div>
      ...
      {mobileNavOpen && (
        <div className="md:hidden" id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link to="/government" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-50">
              Dashboard
            </Link>
            <Link to="/government/incidents" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-50">
              Incidents
            </Link>
            <Link to="/government/charities" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-50">
              Charities
            </Link>
            <Link to="/government/news" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-50">
              News
            </Link>
            <Link to="/government/reports" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-50">
              Reports
            </Link>
            <Link to="/government/settings" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-50">
              Settings
            </Link>
          </div>
          <div className="pt-4 pb-3 border-t border-gray-200">
            ...
            <div className="mt-3 px-2 space-y-1">
              ...
              <button
                onClick={handleLogout}
                className="w-full text-left block px-3 py-2 rounded-md text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-50"
              >
                Sign out
              </button>
            </div>
