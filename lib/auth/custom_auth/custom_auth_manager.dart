...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    cDRPProjectAuthUserSubject.add(
      CDRPProjectAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<CDRPProjectAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  CDRPProjectAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = CDRPProjectAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    cDRPProjectAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
CDRPProjectAuthUser? currentUser;
