          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(150.0, 9.0, 0.0, 0.0),
                  child: InkWell(
                    ...
                    onTap: () async {
                      context.pushNamed(RestPasswordWidget.routeName);
                    },
                    child: Text(
                      'Forgot Password?',
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      _model.loginAPI = await UserGroup.loginUserCall.call(
                        email: _model.textFieldTextController.text,
                      ...
                      if ((_model.loginAPI?.succeeded ?? true)) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            ...
                            duration: Duration(milliseconds: 4000),
                            backgroundColor: Color(0xFFF7070E),
                          ),
                        );
                      }
